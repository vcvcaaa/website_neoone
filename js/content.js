const content = {
    ...
          whyus_1: "Private Deployment: Full control, maximum security.",
          whyus_2: "Industry Savvy: We understand your domain language.",
          whyus_3: "Modular & Flexible: Introduce AI step-by-step.",
          whyus_4: "Partners in Transformation: We provide training and support.",
      
    ...
          // Solution 1 (Original features were already using li, kept as is)
    ...
          // Solution 2 (Original features were already using li, kept as is)
    ...
          // Solution 3 (Original features were already using li, kept as is)
    ...
          // Solution 4 (Original features were already using li, kept as is)
    ...
          // Solution 5 (Original features were already using li, kept as is)
    ...
          // Common Keys for Detail Pages
          view_details: "View Details",
          contact_us_for_demo: "Contact Us for a Demo", // Or "Contact Us for a Personalized Demo" used below
          solution_detail_subtitle: "Empowering Your Support Team", // Example, might be overridden
          solution_detail_key_features: "Key Features & Technology", // Example, might be overridden
    ...
          // solution_detail_key_features: "Key Features & Technology", // Defined above
          solution_detail_benefits_title: "How You Benefit",
          solution_detail_use_cases_title: "Ideal Use Cases",
          solution_detail_implementation_title: "Our Implementation Approach", // Title for the section
          solution_detail_why_us_title: "Why Choose Our Approach?",
          contact_us_for_demo_detail: "Contact Us for a Personalized Demo", // Specific CTA for detail pages
          
          // Placeholder AI Assistant Detail Page (Check if implementation needs formatting)
    ...
          solution_detail_ai_assistant_features: `<li>On-Premise RAG Integration: Securely leverages your internal documents...</li><li>Contextual Understanding: Maintains conversation context...</li><li>... [More features]</li>`, // Already uses li
          solution_detail_ai_assistant_benefits: `<li>Reduce Agent Load: Handles common queries automatically...</li><li>... [More benefits]</li>`, // Already uses li
          // **** MODIFIED **** Applying standard list format if needed
          solution_detail_ai_assistant_implementation: `<p>Our process typically involves:</p><ol><li><strong>Knowledge Base Assessment & Ingestion:</strong> Understanding your data.</li><li><strong>RAG Configuration:</strong> Setting up the core engine.</li><li><strong>Integration & Testing:</strong> Connecting to channels and testing.</li><li><strong>Training & Rollout:</strong> Equipping your team.</li></ol>`, // Example formatted steps
    ...
            <li>Multi-Format Support: Handles data from Excel, CSV, PDF (native & scanned with OCR), databases, APIs, and more.</li>
            <li>Automated Data Extraction: Intelligently identifies and extracts relevant fields, tables, and information.</li>
            <li>Intelligent Cleaning & Validation: Applies customizable rules for standardization (dates, addresses, codes), outlier detection, deduplication, and missing value handling.</li>
            <li>Schema Mapping & Transformation: Structures data into your desired target format or database schema.</li>
            <li>Scalable Processing: Capable of handling large volumes of data efficiently.</li>
            <li>Quality Reporting & Audit Trail: Provides insights into data quality improvements and processing steps.</li>
        `, // Kept as is (already uses li)
          solution_detail_data_cleansing_benefits_list_html: `
            <li>Enable Reliable Analytics & BI: Base your reports and dashboards on accurate, trustworthy data.</li>
            <li>Build High-Performing AI Models: Improve AI accuracy and reduce bias by training on clean, structured data.</li>
            <li>Streamline System Migrations: Ensure smooth data transfer with consistent formatting.</li>
            <li>Increase Operational Efficiency: Reduce manual data entry and correction time significantly.</li>
            <li>Enhance Data Governance: Establish a foundation of high-quality, standardized data across the organization.</li>
            <li>Make Data-Driven Decisions with Confidence: Trust the insights derived from your data.</li>
        `, // Kept as is (already uses li)
          solution_detail_data_cleansing_use_cases_desc: "Essential for preparing data for business intelligence tools (Tableau, Power BI), machine learning projects, ERP/CRM system implementation or migration, data warehousing, compliance reporting, and unifying data from mergers or acquisitions.",
          // **** MODIFIED ****
          solution_detail_data_cleansing_implementation_desc: `<p>Our approach:</p><ol><li><strong>Data Source Assessment & Profiling:</strong> Understanding your raw data.</li><li><strong>Rule Definition & Configuration:</strong> Setting up cleansing and structuring logic.</li><li><strong>Automated Extraction & Cleansing Pilot:</strong> Testing the process on a sample.</li><li><strong>Full-Scale Processing & Structuring:</strong> Applying rules to all data.</li><li><strong>Quality Validation & Delivery:</strong> Ensuring accuracy and delivering results.</li><li><strong>Optional: Setup ongoing data pipelines:</strong> For continuous data needs.</li></ol>`,
    ...
            <li>On-Premise or Private Cloud Deployment: Ensures complete data confidentiality and security. Your documents never leave your control.</li>
            <li>Retrieval-Augmented Generation (RAG): Combines powerful large language models with direct retrieval from your documents for factual, cited answers. Reduces hallucination risk.</li>
    ...
        solution_detail_rag_kb_use_cases_desc: "Ideal for internal Q&A systems, R&D knowledge management, accessing compliance & legal documents, technical support knowledge bases, finding project histories, and surfacing insights from vast internal document repositories.",
          // **** MODIFIED ****
        solution_detail_rag_kb_implementation_desc: `<p>Our process:</p><ol><li><strong>Needs Analysis & Scope Definition:</strong> Defining your knowledge goals.</li><li><strong>Infrastructure Setup (On-Premise/Private Cloud):</strong> Preparing the secure environment.</li><li><strong>Document Collection & Secure Ingestion Pipeline:</strong> Gathering and importing knowledge safely.</li><li><strong>RAG System Configuration & Indexing:</strong> Setting up the AI and indexing documents.</li><li><strong>User Interface & Access Control Setup:</strong> Creating the search interface and permissions.</li><li><strong>Testing, Training & Rollout:</strong> Ensuring functionality and user adoption.</li></ol>`,
    ...
            <li>Automated Data Integration: Connectors for various internal systems (ERP, CRM, databases) and external data feeds (APIs, web scraping for public data).</li>
            <li>Internal & External Data Fusion: Correlates your company's performance with market dynamics, competitor moves, supply chain events, and economic trends.</li>
    ...
        solution_detail_analysis_use_cases_desc: "Valuable for strategic planning, sales forecasting & pipeline management, supply chain risk assessment, competitive intelligence monitoring, market entry analysis, pricing optimization, and executive performance dashboards.",
          // **** MODIFIED ****
        solution_detail_analysis_implementation_desc: `<p>Our approach:</p><ol><li><strong>Requirements & KPI Definition:</strong> Identifying key metrics and report needs.</li><li><strong>Data Source Identification & Integration Setup:</strong> Connecting internal and external data.</li><li><strong>AI Model Selection & Configuration:</strong> Choosing and tuning analysis algorithms.</li><li><strong>External Data Feed Setup:</strong> Establishing reliable external data streams.</li><li><strong>Report Template & Dashboard Design:</strong> Creating the output format.</li><li><strong>Automation & Scheduling:</strong> Setting up automated report generation.</li><li><strong>Validation & Rollout:</strong> Verifying accuracy and launching the system.</li></ol>`,
    ...
        solution_detail_quality_use_cases_desc: "Highly effective for manufacturing process control, incoming material inspection analysis, final product quality assurance, predictive maintenance based on quality indicators, supplier quality monitoring, and optimizing complex assembly lines.",
          // **** MODIFIED ****
        solution_detail_quality_implementation_desc: `<p>Our process:</p><ol><li><strong>Goal Setting & Data Source Mapping:</strong> Defining quality objectives and identifying data points.</li><li><strong>Data Integration & Preparation:</strong> Connecting and cleaning quality data.</li><li><strong>AI Model Selection & Training:</strong> Developing anomaly detection and prediction models.</li><li><strong>Alert & Recommendation Engine Configuration:</strong> Setting up triggers and suggestion logic.</li><li><strong>Dashboard Setup & User Training:</strong> Visualizing results and training users.</li><li><strong>Deployment & Performance Monitoring:</strong> Launching and tracking the system's effectiveness.</li></ol>`,
    ...
            <li>Cloud Migration Strategy & Execution: Assess workloads, design target architecture (Public/Private/Hybrid), and manage seamless migration of servers, databases (e.g., Oracle to PostgreSQL), ERP, MES systems.</li>
            <li>Open Source Stack Implementation: Replace expensive commercial software with proven, enterprise-grade open source solutions (Linux OS, KVM/Proxmox virtualization, Ceph storage, Ansible automation, etc.).</li>
    ...
            <li>Containerization & Orchestration: Modernize applications using Docker and Kubernetes for scalability and portability.</li>
    ...
        solution_detail_it_use_cases_desc: "Ideal for companies seeking to lower IT operational costs, businesses migrating away from expensive Oracle or Microsoft licenses, organizations adopting cloud-native applications or AI/ML platforms, and enterprises needing scalable, resilient, and remotely manageable infrastructure.",
          // **** MODIFIED **** (This matches the original example provided by the user)
        solution_detail_it_implementation_desc: `<p>Our phased approach:</p><ol><li><strong>Assessment & TCO Analysis:</strong> Understanding your current setup and costs.</li><li><strong>Target Architecture Design & PoC:</strong> Planning the future state and validating concepts.</li><li><strong>Phased Migration Planning & Execution:</strong> Carefully planning and executing the move.</li><li><strong>Open Source Integration & Configuration:</strong> Setting up and tuning open-source alternatives.</li><li><strong>Security Hardening & Testing:</strong> Ensuring the new environment is secure and functional.</li><li><strong>Handover, Training & Ongoing Support Options:</strong> Transitioning management and providing support.</li></ol>`,
    ...
          whyus_1: "私有部署： 全面掌控，最高安全。",
          whyus_2: "產業洞察： 我們懂您的行業語言。",
          whyus_3: "模組彈性： 循序漸進導入 AI。",
          whyus_4: "轉型夥伴： 提供完整培訓與支援。",
      
           // Solutions Page (solutions.html)
    ...
          // Common Keys for Detail Pages
          view_details: "查看詳情",
          contact_us_for_demo: "聯繫我們獲取演示", // Or "聯繫我們獲取個人化演示" used below
          solution_detail_subtitle: "賦能您的支援團隊", // 示例, 可能被覆蓋
          solution_detail_key_features: "關鍵功能與技術", // 示例, 可能被覆蓋
    ...
          // solution_detail_key_features: "關鍵功能與技術", // Defined above
          solution_detail_benefits_title: "您將如何受益",
          solution_detail_use_cases_title: "理想應用場景",
          solution_detail_implementation_title: "我們的實施方法", // Section title
          solution_detail_why_us_title: "為何選擇我們的方案？",
          contact_us_for_demo_detail: "聯繫我們獲取個人化演示", // Specific CTA for detail pages
    ...
          solution_detail_ai_assistant_features: `<li>本地 RAG 整合： 通過檢索增強生成技術安全地利用您的內部文檔...</li><li>上下文理解： 在多輪互動中保持對話上下文...</li><li>... [更多中文功能]</li>`, // Already uses li
          solution_detail_ai_assistant_benefits: `<li>減少客服負荷： 自動處理常見查詢...</li><li>... [更多中文效益]</li>`, // Already uses li
          // **** MODIFIED **** Applying standard list format if needed (Chinese version)
          solution_detail_ai_assistant_implementation: `<p>我們的流程通常包含：</p><ol><li><strong>知識庫評估與導入：</strong> 了解您的數據。</li><li><strong>RAG 配置：</strong> 設定核心引擎。</li><li><strong>整合與測試：</strong> 連接渠道並進行測試。</li><li><strong>培訓與推廣：</strong> 協助您的團隊上手。</li></ol>`, // Example formatted steps
    ...
          solution_detail_data_cleansing_features_list_html: `
            <li>多格式支持： 處理來自 Excel、CSV、PDF（原生及掃描 OCR）、數據庫、API 等的數據。</li>
            <li>自動化數據提取： 智能識別並提取相關字段、表格和信息。</li>
            <li>智能清理與驗證： 應用可定制規則進行標準化（日期、地址、代碼）、異常值檢測、重複數據刪除和缺失值處理。</li>
            <li>模式映射與轉換： 將數據結構化為您期望的目標格式或數據庫模式。</li>
            <li>可擴展處理： 能夠高效處理大量數據。</li>
            <li>質量報告與審計追踪： 提供數據質量改進和處理步驟的洞察。</li>
        `, // Kept as is (already uses li)
          solution_detail_data_cleansing_benefits_list_html: `
            <li>實現可靠的分析與 BI： 將您的報告和儀表板建立在準確、可信的數據之上。</li>
            <li>構建高性能 AI 模型： 通過在乾淨、結構化的數據上進行訓練，提高 AI 準確性並減少偏差。</li>
            <li>簡化系統遷移： 確保數據以一致的格式順利傳輸。</li>
            <li>提高運營效率： 大幅減少手動數據輸入和校正時間。</li>
            <li>加強數據治理： 為整個組織建立高質量、標準化數據的基礎。</li>
            <li>自信地做出數據驅動決策： 信任從您的數據中得出的見解。</li>
        `, // Kept as is (already uses li)
          solution_detail_data_cleansing_use_cases_desc: "對於為商業智能工具（Tableau, Power BI）準備數據、機器學習項目、ERP/CRM 系統實施或遷移、數據倉庫建設、合規報告以及整合來自併購的數據至關重要。",
          // **** MODIFIED ****
          solution_detail_data_cleansing_implementation_desc: `<p>我們的方法：</p><ol><li><strong>數據源評估與分析：</strong> 了解您的原始數據狀況。</li><li><strong>規則定義與配置：</strong> 設定清理與結構化的邏輯。</li><li><strong>自動化提取與清理試點：</strong> 在樣本數據上測試流程。</li><li><strong>全面處理與結構化：</strong> 將規則應用於所有數據。</li><li><strong>質量驗證與交付：</strong> 確保準確性並交付成果。</li><li><strong>可選：建立持續數據管道：</strong> 滿足持續性的數據需求。</li></ol>`,
    ...
        solution_detail_rag_kb_features_list_html: `
            <li>本地或私有雲部署： 確保完全的數據機密性和安全性。您的文檔永遠不離開您的掌控。</li>
            <li>檢索增強生成 (RAG)： 將強大的大型語言模型與直接從您的文檔中檢索相結合，提供基於事實、可引用的答案。降低「幻覺」風險。</li>
            <li>廣泛的文檔支持： 導入各種格式，如 PDF、Word、PowerPoint、HTML、文本，並與現有數據庫或 SharePoint 集成。</li>
            <li>自然語言查詢： 用戶以通俗語言提問，無需複雜的搜索語法。</li>
            <li>來源引用： 答案包含指向源文檔的直接鏈接或引用，以便核實。</li>
            <li>訪問控制集成： 可與您現有的用戶身份驗證集成，實現基於權限的知識訪問。</li>
            <li>自動更新： 持續索引新的和更新的文檔，保持知識的時效性。</li>
        `, // Kept as is (already uses li)
        solution_detail_rag_kb_benefits_list_html: `
            <li>加速信息發現： 在幾秒鐘內找到準確的答案和相關文檔，而不是幾小時。</li>
            <li>提升員工生產力與效率： 減少搜索和詢問同事信息的時間。</li>
            <li>保存並利用企業知識： 防止因員工流失造成的知識損失，使專業知識易於獲取。</li>
            <li>增強決策制定： 快速訪問相關的內部數據和見解。</li>
            <li>改善入職與培訓： 為新進人員提供即時的公司知識資源。</li>
            <li>維護數據安全與合規： 在您的環境中保護敏感的內部信息。</li>
        `, // Kept as is (already uses li)
        solution_detail_rag_kb_use_cases_desc: "適用於內部問答系統、研發知識管理、訪問合規與法律文件、技術支援知識庫、查找項目歷史記錄，以及從海量內部文檔庫中挖掘見解。",
          // **** MODIFIED ****
        solution_detail_rag_kb_implementation_desc: `<p>我們的流程：</p><ol><li><strong>需求分析與範圍界定：</strong> 定義您的知識目標。</li><li><strong>基礎設施建立（本地/私有雲）：</strong> 準備安全的運行環境。</li><li><strong>文檔收集與安全導入管道：</strong> 安全地收集與匯入知識文件。</li><li><strong>RAG 系統配置與索引：</strong> 設定 AI 引擎並索引文件。</li><li><strong>用戶界面與訪問控制設置：</strong> 建立搜索界面與權限管理。</li><li><strong>測試、培訓與推廣：</strong> 確保功能完善與用戶採納。</li></ol>`,
    ...
        solution_detail_analysis_features_list_html: `
            <li>自動化數據整合： 提供針對各種內部系統（ERP、CRM、數據庫）和外部數據源（API、公共數據網絡爬蟲）的連接器。</li>
            <li>內外部數據融合： 將您公司的績效與市場動態、競爭對手舉動、供應鏈事件和經濟趨勢相關聯。</li>
            <li>AI 驅動模式識別與預測： 利用機器學習識別趨勢，預測未來結果（例如銷售預測、風險可能性），並檢測異常。</li>
            <li>可操作的見解與建議： 不僅僅是數據呈現，還能根據分析結果建議潛在策略或緩解措施。</li>
            <li>可定制報告格式： 以結構化報告（PDF、PPT）、交互式儀表板或電子郵件警報的形式提供見解。</li>
            <li>計劃與按需生成： 配置定期報告交付或根據需要生成分析。</li>
            <li>私密與安全分析： 所有分析，尤其是涉及敏感內部數據的分析，都在您的安全環境中運行。</li>
        `, // Kept as is (already uses li)
        solution_detail_analysis_benefits_list_html: `
            <li>獲得前瞻性戰略洞察： 在為時已晚之前了解市場變化及其對您業務的影響。</li>
            <li>提高預測準確性： 為銷售、需求和資源規劃做出更好的預測。</li>
            <li>識別隱藏風險與機遇： 發現潛在的供應鏈中斷、競爭威脅或新興市場機會。</li>
            <li>節省大量分析師時間： 自動化數據收集、整合和報告創建的繁瑣過程。</li>
            <li>確保報告一致與及時： 定期收到可靠的見解，無需手動延遲或變動。</li>
            <li>促進數據驅動決策： 為您的領導層和團隊提供清晰、可操作的情報。</li>
        `, // Kept as is (already uses li)
        solution_detail_analysis_use_cases_desc: "適用於戰略規劃、銷售預測與管道管理、供應鏈風險評估、競爭情報監控、市場進入分析、定價優化和高階主管績效儀表板。",
          // **** MODIFIED ****
        solution_detail_analysis_implementation_desc: `<p>我們的方法：</p><ol><li><strong>需求與 KPI 定義：</strong> 確認關鍵指標與報告需求。</li><li><strong>數據源識別與整合設置：</strong> 連接內外部數據來源。</li><li><strong>AI 模型選擇與配置：</strong> 選擇並調校分析算法。</li><li><strong>外部數據源設置：</strong> 建立可靠的外部數據流。</li><li><strong>報告模板與儀表板設計：</strong> 設計最終的輸出格式。</li><li><strong>自動化與排程：</strong> 設定自動化報告生成機制。</li><li><strong>驗證與推廣：</strong> 驗證準確性並導入系統。</li></ol>`,
    ...
        solution_detail_quality_features_list_html: `
            <li>直接數據連接： 與 MES、SCADA、PLC、品質管理系統 (QMS)、LIMS 和手動檢驗數據集成。</li>
            <li>AI 驅動異常檢測： 識別通常在缺陷發生前出現的、偏離正常操作參數的異常模式和偏差。</li>
            <li>根本原因分析輔助： 找出與品質問題相關的統計顯著因素（例如特定的機器設置、材料批次、環境條件）。</li>
            <li>預測性質量警報： 為可能導致不合格產品的批次或流程提供早期預警。</li>
            <li>可操作的改進建議： 基於歷史數據和最佳實踐，建議特定的參數調整或流程更改。</li>
            <li>可視化儀表板與報告： 為工程師和管理人員清晰呈現品質趨勢、警報和分析結果。</li>
            <li>領域特定模型： 利用適合製造業和時間序列品質數據的算法。</li>
        `, // Kept as is (already uses li)
        solution_detail_quality_benefits_list_html: `
            <li>降低報廢與返工成本： 在流程早期發現潛在問題，最大限度地減少浪費。</li>
            <li>提高產品質量一致性與可靠性： 維持更高的質量標準並減少變異。</li>
            <li>降低保修索賠與退貨： 防止有缺陷的產品流向客戶。</li>
            <li>優化製程參數： 微調機器設置和流程以實現最高品質良率。</li>
            <li>賦能工程師數據洞察： 提供可操作的見解，以加快故障排除和持續改進。</li>
            <li>從被動轉向主動品質控制： 預測並預防問題，而不僅僅是應對問題。</li>
        `, // Kept as is (already uses li)
        solution_detail_quality_use_cases_desc: "高效適用於製造過程控制、進料檢驗分析、最終產品質量保證、基於品質指標的預測性維護、供應商品質監控以及優化複雜裝配線。",
          // **** MODIFIED ****
        solution_detail_quality_implementation_desc: `<p>我們的流程：</p><ol><li><strong>目標設定與數據源映射：</strong> 定義品質目標並識別數據點。</li><li><strong>數據整合與準備：</strong> 連接並清理品質相關數據。</li><li><strong>AI 模型選擇與訓練：</strong> 開發異常偵測與預測模型。</li><li><strong>警報與建議引擎配置：</strong> 設定觸發條件與建議邏輯。</li><li><strong>儀表板設置與用戶培訓：</strong> 可視化結果並培訓使用者。</li><li><strong>部署與績效監控：</strong> 上線並追蹤系統成效。</li></ol>`,
    ...
        solution_detail_it_features_list_html: `
            <li>雲遷移策略與執行： 評估工作負載，設計目標架構（公有/私有/混合雲），並管理伺服器、數據庫（例如 Oracle 到 PostgreSQL）、ERP、MES 系統的無縫遷移。</li>
            <li>開源技術棧實施： 以經過驗證的企業級開源解決方案（Linux 操作系統、KVM/Proxmox 虛擬化、Ceph 存儲、Ansible 自動化等）取代昂貴的商業軟件。</li>
            <li>基礎設施即代碼 (IaC)： 使用 Terraform 和 Ansible 等工具自動化基礎設施配置和管理，以實現一致性和效率。</li>
            <li>容器化與編排： 使用 Docker 和 Kubernetes 將應用程序現代化，以提高可擴展性和可移植性。</li>
            <li>強大的安全與合規： 基於最佳實踐實施防火牆、VPN、備份/災難恢復、身份管理和日誌記錄。</li>
            <li>成本優化： 分析雲支出並實施降低運營費用的策略。</li>
            <li>團隊培訓與文檔化： 為您的 IT 團隊提供有效管理新環境所需的技能和 SOP。</li>
        `, // Kept as is (already uses li)
        solution_detail_it_benefits_list_html: `
            <li>顯著降低 IT 支出： 大幅降低與軟件授權、硬體維護和數據中心開銷相關的成本。</li>
            <li>提高敏捷性與可擴展性： 根據需求輕鬆擴展或縮減資源；更快地部署新服務。</li>
            <li>消除供應商鎖定： 通過使用開放標準和技術獲得自由和靈活性。</li>
            <li>增強系統可靠性與性能： 利用現代雲基礎設施和穩定的開源軟件。</li>
            <li>改善安全態勢： 實施當前的安全最佳實踐和架構。</li>
            <li>構建面向未來的基礎： 創建 AI、大數據和數位轉型所需的強大、靈活的基礎設施。</li>
        `, // Kept as is (already uses li)
        solution_detail_it_use_cases_desc: "適用於尋求降低 IT 運營成本的公司、從昂貴的 Oracle 或 Microsoft 授權遷移的企業、採用雲原生應用程序或 AI/ML 平台的組織，以及需要可擴展、彈性且可遠程管理的基礎設施的企業。",
          // **** MODIFIED **** (This matches the original example provided by the user)
          solution_detail_it_implementation_desc: `<p>我們的分階段方法：</p><ol><li><strong>評估與 TCO 分析：</strong> 了解您現況與總體擁有成本。</li><li><strong>目標架構設計與概念驗證 (PoC)：</strong> 規劃未來架構並驗證可行性。</li><li><strong>分階段遷移規劃與執行：</strong> 詳盡規劃並逐步執行遷移。</li><li><strong>開源整合與配置：</strong> 導入並設定開源替代方案。</li><li><strong>安全強化與測試：</strong> 確保新環境的安全與功能正常。</li><li><strong>交付、培訓與持續支持選項：</strong> 完成移交、提供培訓及後續支援。</li></ol>`,
